...
<menu itemscope itemtype="https://schema.org/SiteNavigationElement" class="flex flex-wrap justify-center gap-x-4 max-w-none mt-0 text-xl md:text-2xl lg:flex-col lg:sticky lg:top-10 lg:text-xl" aria-label="Main">
  ...
  <li class="group"{{ in_array(Route::currentRouteName(), [
    ...
    <a itemprop="url" class="block p-2 hover:bg-amber-50 group-aria-selected:bg-amber-200 hover:text-blue-500 lg:py-2 lg:px-4" href="{{ action(Article\IndexController::class) }}" title="{{ __('Articles') }}">
  ...
  <li class="group"{{ in_array(Route::currentRouteName(), [
    ...
    <a itemprop="url" class="block p-2 hover:bg-amber-50 group-aria-selected:bg-amber-200 hover:text-blue-500 lg:py-2 lg:px-4" href="{{ action(Project\IndexController::class) }}" title="{{ __('Projects') }}">
  ...
  <li class="group"{{ in_array(Route::currentRouteName(), [
    ...
    <a itemprop="url" class="block p-2 hover:bg-amber-50 group-aria-selected:bg-amber-200 hover:text-blue-500 lg:py-2 lg:px-4" href="{{ action(Client\IndexController::class) }}" title="{{ __('Clients') }}">
  ...
  <li class="group"{{ in_array(Route::currentRouteName(), [
    ...
    <a itemprop="url" class="block p-2 hover:bg-amber-50 group-aria-selected:bg-amber-200 hover:text-blue-500 lg:py-2 lg:px-4" href="{{ action(Taxonomy\IndexController::class) }}" title="{{ __('Categories') }}">
