<figure {{ $attributes->merge([ 'class' => 'alert' ]) }} role="alert" aria-label="alert">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="icon--status" width="32" height="32" role="img" aria-hidden="true">
