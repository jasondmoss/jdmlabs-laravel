<!-- message.blade -->
<figure class="flex gap-x-5 my-10 mx-10 px-10 py-5 border rounded-md shadow-md {{ $context }}" role="alert" aria-label="alert">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-6 h-6" role="img" aria-hidden="true">
