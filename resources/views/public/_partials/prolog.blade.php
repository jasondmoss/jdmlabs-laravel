...
-->
@if (Request::is('/'))
<title>{{ config('jdmlabs.base.title_home', 'JdmLabs') }}</title>
@elseif ($title)
...
<meta property="og:title" content="@if ($title){{ $title }} &#160;&#11825;&#160; @endif{{ config('jdmlabs.base.title', 'JdmLabs') }}">
<meta property="og:description" content="{{ config('jdmlabs.base.description') }}">
<meta property="og:image" content="{{ Vite::asset('resources/assets/images/' . config('jdmlabs.base.image_share', '')) }}">

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:creator:id" content="156621819">
<meta name="twitter:url" content="{{ config('app.url') }}">
<meta name="twitter:title" content="@if ($title){{ $title }} &#160;&#11825;&#160;@endif {{ config('jdmlabs.base.title', 'JdmLabs') }}">
<meta name="twitter:description" content="{{ config('jdmlabs.base.description') }}">
<meta name="twitter:image" content="{{ Vite::asset('resources/assets/images/' . config('jdmlabs.base.image_share', '')) }}">
