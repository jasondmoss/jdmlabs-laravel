<nav itemprop="publisher" itemscope itemtype="https://schema.org/Organization" class="branding" tabindex="-1" aria-label="{{ __('Branding') }}">
  <a itemprop="url" rel="index" href="{{ config('app.url') }}" title="@yield('title')" aria-label="{!! __('JdmLabs Homepage') !!}">
    {{-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 569.16 569.16" class="brand-logo" width="32" height="32" aria-hidden="true"
    ...
    <span itemprop="name" class="brand-name">JdmLabs</span>
  </a>
  <p itemprop="slogan" class="brand-slogan"><span>Compliant.</span> <span>Portable.</span> <span>Functional.</span></p>
</nav>
