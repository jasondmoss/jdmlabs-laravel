...
@if (auth()->check())
    <menu itemscope itemtype="https://schema.org/SiteNavigationElement" class="account-clone">
      <li><a itemprop="url" href="{{ route('clear-cache') }}">
      ...
      <li><a itemprop="url" wire:navigate href="{{ route('dashboard') }}">
        ...
        <span class="srt">{{ __('Ænginus') }}</span>
        </a></li>
      <li><a itemprop="url" wire:navigate href="{{ route('account') }}">
        ...
        <span class="srt">{{ __('Account') }}</span>
      </a></li>
      <li>
        <a itemprop="url" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logoutFormClone').submit();">
          ...
          <span class="srt">{{ __('Logout') }}</span>
        </a>
        <form id="logoutFormClone" class="srt" method="POST" action="{{ route('logout') }}">@csrf</form>
      </li>
    </menu>
@endif
  </div>
