...
</head><body itemscope itemtype="https://schema.org/{{ $schema }}" class="container mx-auto type--{{ $type }} {{ $page }}{{ Auth::check() ? ' logged-in': '' }}">
...
<header itemscope itemtype="https://schema.org/WPHeader" id="siteHeader" class="site--header">
  ...
  @if (auth()->check())
    <menu itemscope itemtype="https://schema.org/SiteNavigationElement" id="accountMain" class="navigation menu--account" aria-label="Main navigation">
      <li class="menu-item">
        <a itemprop="url" href="{{ route('dashboard') }}" class="menu-link"><span>{{ __('Ænginus') }}</span></a>
      </li>
      <li class="menu-item">
        <a itemprop="url" href="{{ route('account') }}" class="menu-link"><span>{{ __('Account') }}</span></a>
      </li>
      <li class="menu-item">
        <a itemprop="url" href="{{ route('logout') }}" class="menu-link" onclick="event.preventDefault();document.getElementById('logoutForm').submit();"><span>{{ __('Logout') }}</span></a>
        <form id="logoutForm" class="sr-only" method="POST" action="{{ route('logout') }}">@csrf</form>
      </li>
    </menu>
  @endif

  <menu itemscope itemtype="https://schema.org/SiteNavigationElement" id="menuMain" class="navigation menu--main" aria-label="Main navigation">
    <li class="menu-item{{--{{ Route::currentRouteName() == 'public.article.index' ? ' active' : '' }}--}}">
      <a itemprop="url" class="menu-link" href="/articles" title="{{ __('Articles') }}"><span>{{ __('Articles') }}</span></a>
    </li>
    <li class="menu-item{{ Route::currentRouteName() === 'projects' ? ' active' : '' }}">
      <a itemprop="url" class="menu-link" href="/projects" title="{{ __('Projects') }}"><span>{{ __('Projects') }}</span></a>
    </li>
    <li class="menu-item{{ Route::currentRouteName() === 'clients' ? ' active' : '' }}">
      <a itemprop="url" class="menu-link" href="/clients" title="{{ __('Clients') }}"><span>{{ __('Clients') }}</span></a>
    </li>
    <li class="menu-item{{ Route::currentRouteName() === 'about' ? ' active' : '' }}">
      <a itemprop="url" class="menu-link" href="/about" title="{{ __('About') }}"><span>{{ __('About') }}</span></a>
    </li>
    <li class="menu-item{{ Route::currentRouteName() === 'now' ? ' active' : '' }}">
      <a itemprop="url" class="menu-link" href="/now" title="{{ __('Now') }}"><span>{{ __('Now') }}</span></a>
    </li>
  </menu>
</header>


<main id="siteContent" class="flex flex-row flex-wrap py-4" aria-label="Main Content">
  @if ($errors->any())
