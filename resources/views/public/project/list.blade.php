  ...
  @foreach ($projects as $project)
    <article class="">
      <figure class="item--image">
        <a href="{{ action(\App\Project\Interface\Web\Controllers\SingleController::class, $project->slug) }}" title="{{ __('View project') }}">
      ...
      <footer>
        @if (@auth()->check())
          <a rel="nofollow" class="button" href="{{ action(\App\Project\Interface\Web\Controllers\EditController::class, $project->id) }}">{{ __('Edit') }}</a>
        @endif
      </footer>
    </article>
