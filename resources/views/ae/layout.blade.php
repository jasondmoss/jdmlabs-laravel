  ...
  <nav id="menuMain" class="navigation menu--main" aria-label="Main">
    <menu>
      ...
      <li class="menu-item{{ Route::currentRouteName() == 'admin.articles' ? ' active' : '' }}">
        <a href="{{ action(\Aenginus\Article\Interface\Web\Controllers\IndexController::class) }}" title="" class="menu-link">
          <span>{{ __('Articles') }}</span></a>
      </li>
      <li class="menu-item{{ Route::currentRouteName() == 'admin.projects' ? ' active' : '' }}">
        <a href="{{ action(\Aenginus\Project\Interface\Web\Controllers\IndexController::class) }}" title="" class="menu-link">
          <span>{{ __('Projects') }}</span></a>
      </li>
      <li class="menu-item{{ Route::currentRouteName() == 'admin.clients' ? ' active' : '' }}">
        <a href="{{ action(\Aenginus\Client\Interface\Web\Controllers\IndexController::class) }}" class="menu-link">
          <span>{{ __('Clients') }}</span></a>
      </li>
      <li class="menu-item">
        <a href="{{ action(\Aenginus\Taxonomy\Interface\Web\Controllers\IndexController::class) }}" title="" class="menu-link">
