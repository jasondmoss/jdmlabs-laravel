      ...
      @foreach ($clients as $client)
        <client id="item-{{ $client->id }}" class="item">
          ...
          <aside class="item--meta">
            <span class="status"
              wire:click="toggleStatePublished('{{ $client->id }}')"
              title="@if ('published' === $client->status->value) {{ __('Unpublish this client') }} @else {{ __('Publish this client') }} @endif"
            >
              {!! Status::icon($client->status) !!}
            </span>
            <span class="promoted"
              wire:click="toggleStatePromoted('{{ $client->id }}')"
              title="@if ('promoted' === $client->promoted->value) {{ __('Unpromote this client') }} @else {{ __('Promote this client') }} @endif"
            >
