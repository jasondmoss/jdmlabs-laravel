@php
	use App\Core\Shared\Enums\Pinned;use App\Core\Shared\Enums\Promoted;use App\Core\Shared\Enums\Status;use App\Project\Application\Controllers as Project;
@endphp
@push('scripts')
	@once
