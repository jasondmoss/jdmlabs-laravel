@php
	use App\Client\Application\Controllers as Client;use App\Core\Shared\Enums\Pinned;use App\Core\Shared\Enums\Promoted;use App\Core\Shared\Enums\Status;use App\Project\Application\Controllers as Project;
@endphp
@push('styles')
	@once
		<style>
