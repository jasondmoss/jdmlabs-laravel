...
<div class="trix-button-row">
  ...
  <span class="trix-button-group trix-button-group--block-tools" data-trix-button-group="block-tools">
    ...
    <button type="button" class="trix-button trix-button--icon trix-button--icon-heading-3" data-trix-attribute="heading3" title="Heading 3" tabindex="-1">H3</button>
    <button type="button" class="trix-button trix-button--icon trix-button--icon-heading-4" data-trix-attribute="heading4" title="Heading 4" tabindex="-1">H4</button>
...
<div class="trix-dialogs" data-trix-dialogs>
  <div class="trix-dialog trix-dialog--link" data-trix-dialog="href" data-trix-dialog-attribute="href">
    ...
    /**
     * Trix Editor: Replace `div` with `p` for paragraphs.
     */
    document.addEventListener("trix-before-initialize", () => {
        ...
        Trix.Block.prototype.breaksOnReturn = () => {
        ...
        Trix.LineBreakInsertion.prototype.shouldInsertBlockBreak = () => {
