...
return [
     ...
     *
     * If using the default public filesystem, remember to
     * `artisan storage:link` to a public location
     */
    ...
    'render' => [
        ...
        'placeholder' => [
             ...
             */
            'use_for_missing_files' => env(
                'IMAGERY_RENDER_PLACEHOLDER_USE_FOR_MISSING_FILES',
                false
            )
        ],
     ...
     */
    'force_unmodified_image_rendering' => env(
        'IMAGERY_FORCE_UNMODIFIED_IMAGE_RENDERING',
        false
    ),
    ...
    'urls' => [
         ...
         */
        'presets' => [
             'global_thumbnail' => 'fit_resize|size_100x100|v'
        ],
