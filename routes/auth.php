...
Route::middleware(['web'])->group(static function () {
    ...
    Route::prefix('ae')->group(static function () {
        ...
        Route::get('/access', static function () {
            return view('aenginus.auth.access');
        })->name('access');

        Route::post('/access', [FC\AuthenticatedSessionController::class, 'store'])
            ->middleware(
                array_filter([
        ...
        if (Features::enabled(Features::emailVerification())) {
            ...
            Route::get('/email/verify/{id}/{hash}', [FC\VerifyEmailController::class, '__invoke'])
                ->middleware([
            ...
            Route::post('/email/verification-notification', [FC\EmailVerificationNotificationController::class, 'store'])
        ...
        Route::get('/user/confirm-password', static function () {
        ...
        if (Features::enabled(Features::twoFactorAuthentication())) {
            Route::get('/user/two-factor-challenge', [FC\TwoFactorAuthenticatedSessionController::class, 'create'])
                ->middleware(['guest:' . config('fortify.guard')])->name('two-factor.login');

            Route::get('/user/two-factor-challenge', static function () {
